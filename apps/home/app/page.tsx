      ...
      <section className="px-6 py-6 max-w-3xl mx-auto w-full">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <a href="https://deriv.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 opacity-70 hover:opacity-100 transition-opacity">
            <Image src="/deriv-mark.png" alt="Deriv" width={60} height={60} className="rounded-sm" />
          </a>

          {/* Social icons */}
          <div className="flex items-center gap-3">
            {/* Facebook */}
            <a href="https://www.facebook.com/share/1BqdfwMLRf/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="hover:opacity-80 transition-opacity">
            ...
            {/* Telegram */}
            <a href="https://t.me/binarymatix" target="_blank" rel="noopener noreferrer" aria-label="Telegram" className="hover:opacity-80 transition-opacity">
            ...
            {tenant.supportWhatsapp && (
              <a href={tenant.supportWhatsapp} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="hover:opacity-80 transition-opacity">
          ...
          {tenant.supportEmail && (
            <a
              ...
              className="flex items-center gap-2 text-xs font-medium text-zinc-500 dark:text-zinc-400 hover:underline"
            >
