...
export const metadata: Metadata = {
  title: 'Inbuilt Bots',
  description: 'Ready-made inbuilt trading bots for synthetic indices — coming soon to Binary Matix.',
  alternates: { canonical: 'https://binarymatix.com/bots/inbuilt' },
};
    ...
    <div className="flex flex-col min-h-full bg-[var(--background)] text-[var(--foreground)] pb-14">
      ...
      <section className="flex flex-col px-6 pt-16 pb-10 max-w-2xl mx-auto w-full">
        ...
        <p className="text-sm text-zinc-500 leading-relaxed max-w-md">
          Ready-made bots you can run in one click. Pick a proven strategy, set your stake, and go.
        </p>
      </section>

      {/* Status banner */}
      <section className="px-6 pb-10 max-w-2xl mx-auto w-full">
        <div className="rounded-2xl border border-amber-200 dark:border-amber-900 bg-amber-50 dark:bg-amber-950/40 p-5 flex gap-4 items-start">
          <div className="w-9 h-9 rounded-lg bg-amber-100 dark:bg-amber-900 flex items-center justify-center flex-shrink-0">
          ...
          <div>
            ...
            <p className="text-sm text-zinc-500 leading-relaxed">
              Inbuilt bots are being built. Check this page later for updates, or reach out to support if you have an idea you'd like to see implemented!
            </p>
          </div>
        </div>
      </section>
